...
- Tests avoid loading real models by monkeypatching the remaining CLI builders only for setup/doctor paths, or by injecting fake synthesizers/translators/taggers into `workflow.generate_audio()`.
